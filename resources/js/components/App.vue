        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    ...
                    <img  src="https://img.icons8.com/color/48/000000/vue-js.png" alt="" width="30" height="24">
                </a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <router-link exact-active-class="active" to="/prestamos" class="nav-link">Prestamos</router-link>
                    </li>   
                     <li class="nav-item">
